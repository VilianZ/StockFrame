...
Do not invent causal relationships. Do not invent price projections, price targets, intrinsic value, revenue forecasts, or EPS forecasts. Every number in prose must exactly match a referenced canonical metric, with explicit percentage, thousands, millions, or billions notation allowed when mathematically equivalent. Ignore dates and years as metric values. Before writing a number, verify that at least one cited metric has that exact canonical value; if no cited metric supports the number, omit the sentence. Never use eps_ttm to justify a dividend amount, split ratio, share count, price, or any other corporate-action value.
...
Corporate actions are structured provider events, not articles or news. They are backend-owned and must not appear in profile thesis or profile considerations. Do not mention dividends, splits, mergers, acquisitions, buybacks, listings, delistings, ticker changes, bankruptcies, or other corporate-action events in profile text, even when the packet contains such events. Do not invent event details or present provider text as news; the backend renders supported corporate actions separately.
